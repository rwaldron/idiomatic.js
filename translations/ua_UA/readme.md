...
Проекти повинні старатись включати в себе певний інструментарій для контролю стилю, тестування і стиснення коду. Для цього ви можете використовувати [grunt](https://github.com/cowboy/grunt) від Ben Alman.
