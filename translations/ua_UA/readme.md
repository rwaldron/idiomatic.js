...
2. <a name="spacing">Гарний Синтаксис</a>
    ...
    Абсолютно не важливо, які лапки ви використовуєте(одинарні чи подвійні), нема різниці в тому, як JavaScript обробляє їх. Що **справді важливо**, так це зберігати консистентність. **Ніколи не плутайте лапки в вашому проекті. Оберіть один стиль і притримуйтель його.**
...
4. <a name="cond">Умовні обчислення/Опрацювання</a>
    ...
    ```
    Завжди оцінюйте найкращий і точний результат - вище наведено інструкцію, а не догму.
