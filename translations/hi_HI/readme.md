...
2. <a name="spacing">ब्यूटीफुल सिंटेक्स</a>
    ...
    // फंक्शन इक्स्प्रेशन आइडेंटिफ़ायर के साथ |
    // इस शैली से यह फायदा होता है कि इसके द्वारा फ़ंक्शन स्वयं को ही कॉल कर सकता है 
...
5. <a name="practical">्रैक्टिकल स्टाइल (व्यावहारिक शैली)</a>
