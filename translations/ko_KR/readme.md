...
3. <a name="type">자료형 확인하기 (Courtesy jQuery Core Style Guidelines)</a>
	...
	* 미할당(undefined):
	...
	자바스크립트는 동적 타입의 언어입니다. 자료형의 타입이 변하는 이러한 속성은 양날의 검이 될 수 있으니, 위에서 권한 대로 `type`을 항상 지켜 주세요.
...
보기: https://mail.mozilla.org/pipermail/es-discuss/2011-September/016805.html
메모: "쉼표를 맨앞에 쓰는 건 무서운 일, 그리고 거부하는 이유.", "쉼표를 처음에 쓰는 것은 여전히 피해야 한다."
